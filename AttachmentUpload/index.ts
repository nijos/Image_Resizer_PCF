...
export class AttachmentUpload implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement) {
		...
		if (entityRef) {
			...
			this.uploadProps.imgHeight=context.parameters.ImageHeight.raw||300;
			this.uploadProps.imgWidth=context.parameters.ImageWidth.raw||300;
			this.uploadProps.imgQuality=context.parameters.ImageQuality.raw||100;
